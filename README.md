...
The above link is access to the full website where you see the following webpages:
...
<li>Design Comps-There is a link to xd file where the two developed pages where designed and created before making the design in html and css codes.</li>
